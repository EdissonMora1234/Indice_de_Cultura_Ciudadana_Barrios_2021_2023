document.addEventListener('DOMContentLoaded', function() {
    ...
    var wmsLayers = [
        { url: 'https://geoserver.scrd.gov.co/geoserver/Investigacion_Cultured_Maps/wms', layerName: 'Indice_de_Cultura_Ciudadana_Barrios_2021', displayName: 'Subindice_Cultura_Ciudadana_Barrios_2021' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Investigacion_Cultured_Maps/wms', layerName: 'Indice_de_Cultura_Ciudadana_Barrios_2023', displayName: 'Subindice_Cultura_Ciudadana_Barrios_2023' }
    ];
